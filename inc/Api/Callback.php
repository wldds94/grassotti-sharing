...
class Callback {
	...
	* ------------------------------------------------------------------------ */
	...
	/**
	 * 
	 * Render input option file
	 */
	public function fileField()
	{ ?>
		<div class="wlank-array-input-single input-file-container-wrap flex-column">
			...
			<div class="input-file-content">
				...
				<input id="<?php echo esc_attr( $this->name ); ?>" class="<?php echo esc_attr( $this->classes ); ?> text-box" type="file" 
					name="<?php echo esc_attr( $this->option_name ) . '[' . esc_attr( $this->section ) . ']' . '[' . esc_attr( $this->name ) . ']' . ( $this->index ? '[' . esc_attr($this->index) . ']' : '' ); ?>" 
	...
	{ ?>
		<div class="password-field-container">
			<input id="<?php echo esc_attr( $this->name ); ?>" class="<?php echo esc_attr( $this->classes ); ?>" type="password"
				name="<?php echo esc_attr( $this->option_name ) . '[' . esc_attr( $this->section ) . ']' . '[' . esc_attr( $this->name ) . ']' . ( $this->index ? '[' . esc_attr($this->index) . ']' : '' ); ?>" 
				value="<?php echo esc_attr( $this->value ); ?>" autocomplete="off">

			<button type="button" id="btnToggle_<?php echo esc_attr( $this->name ); ?>" class="toggle"><i id="eyeIcon_<?php echo esc_attr( $this->name ); ?>" class="fa fa-eye"></i></button>
		</div>
		<script>
			let passwordInput = document.getElementById('<?php echo esc_attr( $this->name ); ?>'),
				toggle = document.getElementById('btnToggle_<?php echo esc_attr( $this->name ); ?>'),
				icon =  document.getElementById('eyeIcon_<?php echo esc_attr( $this->name ); ?>');
	...
	public function displayOptionsField( $args )
	{
		...
		switch ( $this->type ) {
			...
			case 'image':
				...
				<input id="<?php echo esc_attr( $this->option_name ) . '_button'; ?>" type="button" data-uploader_title="<?php echo __( 'Upload an image' , 'plugin_textdomain' ); ?>" data-uploader_button_text="<?php echo __( 'Use image' , 'plugin_textdomain' ); ?>" class="image_upload_button button" value="<?php echo  __( 'Upload new image' , 'plugin_textdomain' ); ?>" />
				<input id="<?php echo esc_attr( $this->option_name ) . '_delete'; ?>" type="button" class="image_delete_button button" value="<?php echo __( 'Remove image' , 'plugin_textdomain' ); ?>" />
